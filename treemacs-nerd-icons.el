...
(defvar treemacs-nerd-icons-dir-tab (propertize "\t\t" :face 'treemacs-nerd-icons-file-face))
...
(treemacs-create-theme "nerd-icons"
                       ...
                       (progn
                         ...
                         (treemacs-create-icon :icon (format "%s%s%s" treemacs-nerd-icons-dir-tab (nerd-icons-faicon "nf-fa-folder_open"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               :extensions (dir-open)
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s%s" treemacs-nerd-icons-dir-tab (nerd-icons-faicon "nf-fa-folder"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                         ...
                         (treemacs-create-icon :icon (format "%s%s%s" treemacs-nerd-icons-dir-tab (nerd-icons-faicon "nf-fa-folder"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               ...
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s%s" treemacs-nerd-icons-dir-tab (nerd-icons-octicon "nf-oct-package"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               :extensions (tag-open)
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s%s" treemacs-nerd-icons-dir-tab (nerd-icons-octicon "nf-oct-package"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
